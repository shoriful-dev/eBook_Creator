    ...
    <div id="features" className="relative py-24 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="text-center mt-16">
          ...
          <a href="signup" className='inline-flex items-center space-x-2 bg-linear-to-r from-violet-600 to-purple-600 px-8 py-4 rounded-xl text-white  font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200'>
